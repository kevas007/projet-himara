                ...
                <div class="restaurant-menu-item">
                    <div class="row">
                        <div class="col-lg-4 col-12">
                            <figure>
                                <img src="{{ asset('images/restaurant/restaurant1.jpg') }}" class="img-fluid "
                                    alt="Image">
                            </figure>
                        </div>
            ...
            <div class="col-md-6 col-sm-6 col-6">
                <div class="restaurant-menu-item">
                    <div class="row">
                        <div class="col-lg-4 col-12">
                            <figure>
                                <img src="{{ asset('images/restaurant/restaurant2.jpg') }}" class="img-fluid"
                                    alt="Image">
                            </figure>
                        </div>
                        <div class="col-lg-8 col-12">
...
<!-- ========== VIDEO ========== -->
<section class="video np parallax gradient-overlay op6" data-src="{{ asset('images/video.jpg') }}"
    data-parallax="scroll" data-speed="0.3" data-mirror-selector=".wrapper" data-z-index="0">
